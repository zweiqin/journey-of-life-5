...
export default {
	...
	data() {
		return {
			...
			imgInfo: {},
			qrcodeUrl: 'https://www.tuanfengkeji.cn/JFShop_Uni_H5/#/user/my-tools/smart-album/album-detail?id=',
			shareCode: ''
		}
	},
	onLoad(options) {
	...
	methods: {
		...
		// 		link: `https://www.tuanfengkeji.cn/JFShop_Uni_H5/#/user/my-tools/smart-album/album-detail?id=${this.id}`
		// 	})
		// },
		...
		async handlePopup(obj) {
			...
			if (obj.icon === 'wechat') {
				...
				uni.setClipboardData({
					data: `https://www.tuanfengkeji.cn/JFShop_Uni_H5/#/user/my-tools/smart-album/album-detail?id=${this.id}`,
					success() {
						uni.showToast({
							title: '复制成功',
							duration: 2000,

<template>
	<view class="goods-classification-container">
		...
		<view v-for="item in CategoryList" :key="item.brandId" class="goodsTable">
		...
		<tui-modal :show="modal" custom mask-closable @cancel="closeModal">
			...
			<view class="reportBtn">
				<tui-button
					width="200rpx" height="72rpx" :size="28" type="danger"
					shape="circle"
					@click="handleClick"
				>
					确定
				...
				<tui-button
					width="200rpx" height="72rpx" :size="28" type="gray-primary"
					shape="circle"
					@click="modal = false"
				>
					取消
		...
		<tui-modal :show="createModal" custom mask-closable @cancel="closeModal">
			<tui-form-item label="类名">

  ...
  <view class="voucher-give-container">
    ...
    <view class="main">
      <view class="item give-user" style="margin-bottom: 36upx">
        ...
        <input
          class="input"
          placeholder="请输入要转赠的用户编号"
          type="number"
          v-model.number="giveUserId"
        />
        <button
          :disabled="!giveUserId"
          size="mini"

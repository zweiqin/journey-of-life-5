<template>
	<view class="j-upload-avatar-container">
		<JIcon class="close-icon" width="40" height="40" type="close" @click="$emit('close')"></JIcon>

		<OkingtzCropper save-button-text="确定" @uploadSuccess="uploadSuccess"></OkingtzCropper>

<template>
	<view class="activity-recommendation-container">
		<view class="header">
		...
		<NoData :img="false" color="#fff" text="暂无活动，敬请期待"></NoData>
	</view>
</template>
...
.activity-recommendation-container {
	min-height: 100vh;
	background: linear-gradient(180deg, #ec328f, #fce4f1);

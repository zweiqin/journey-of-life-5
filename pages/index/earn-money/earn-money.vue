<template>
	<view class="earn-money">
		...
		<view class="background">
			<image src="../../../static/index/earn-money/background.png" mode="" />
		</view>
		<view class="main">
			<view class="main-top">
				<view class="top-img">
			...
			<view class="main-bot">
				...
				<view class="level-list">
					<view class="level" v-for="level in levels" :key="level.id">
			...
			<view class="main-foot">
				...
				<view class="why">?</view>
				<!-- <image src="../../../static/index/earn-money/why.png" mode="" /> -->
			</view>
		</view>
	</view>
</template>
		...
		.main-bot {
			...
			.level-list {
				...
				.level {
					...
					border-radius: 8upx;
					background: #FFF8E6;
					border: 0.5px solid rgba(255, 93, 0, 0.38);
					box-sizing: border-box;
					margin-bottom: 20upx;
					display: flex;

<template>
	<view class="sign">
		...
		<image src="../../../static/index/sign/bg.png" mode="" />
		<view class="date">
		...
		<view class="main">
			<view class="integral">
				...
				<view class="i-right" @click="go('/pages/index/sign/points-mall')">前往积分商城</view>
			</view>
			<view class="mid">
				<view class="head-img">
					<image src="../../../static/index/sign/left.png" mode="" />
					<text>积分兑换</text>
					<image src="../../../static/index/sign/right.png" mode="" />
				</view>
				<view class="exchange">
				...
				<view class="text-list">
					...
					<view class="more">
						<text>查看更多</text>
						<image src="../../../static/index/sign/more.png" mode="" />
					</view>
				</view>
...
.sign {
	width: 100vw;
	min-height: 100vh;
	background: linear-gradient(0deg, #FD1A02 0%, #FD7831 65%, #FD4722 100%);
		...
		.mid {
			...
			.exchange {
				...
				.heng {
					width: 100%;
					height: 2upx;
					background: linear-gradient(90deg, #FFFFFF 0%, #D8D8D8 47%, #FFFFFF 100%);
					margin-top: 18upx;
					margin-bottom: 20upx;
				}

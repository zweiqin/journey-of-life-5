<template>
	<view class="shop-container" :style="{ paddingBottom: status === 'loading' ? '100upx' : '' }">
		<view :class="{ fixed: scrollTop > 300 }" style="position: relative;z-index: 1;">
			<view style="position: relative;z-index: 1000000000;background-color: #FFFFFF;">
			...
			<view class="goods-wrapper">
				...
				<scroll-view scroll-x="true" style="position: relative;z-index: 1000000000;background-color: #FFFFFF;">

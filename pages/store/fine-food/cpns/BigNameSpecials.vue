<template>
	<view class="big-name-specials-container">
		<view class="header-pane">
			<BeeIcon :src="require('../../../../static/brand/find-food/big-name.png')" :size="24"></BeeIcon>
					...
					<view class="price-pane">
						<view class="price-detail">
							...
							<view class="hot-wrapper">
								<BeeIcon :src="require('../../../../static/brand/find-food/hot.png')" :size="12"></BeeIcon>
								<text> 爆卖93万+ </text>
								<text> 每单省100元 </text>
							</view>
						</view>
		...
		.goods-info {
			...
			.price-pane {
				...
				.bee-btn {
					width: 200upx;
					height: 100%;
					background: url('../../../../static/brand/find-food/btn-bg.png') no-repeat;

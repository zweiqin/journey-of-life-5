<template>
	<view class="brand-detail-container">
		<view class="navgation_top" :style="{ backgroundColor: 'rgba(255, 255, 255, ' + navOpacity + ')'}"
		...
		<view class="main">
			...
			<tui-tabs class="tabNav" :class="{'sticky-fixed':isTabFixed}" color="#000" selectedColor="#000" size="35"
			...
			<view class="selectBtn" :class="{'selectSticky-fixed':isSelectFixed}">
				<button :class="{isSelect: true}">推荐</button>
			...
			<TabBar :currentTabIndex="currentTab"></TabBar>
		</view>
	</view>
</template>

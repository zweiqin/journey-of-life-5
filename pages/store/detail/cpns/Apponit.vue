<template>
	<view class="apponit-pane">
		<view v-if="apponitList.length" class="apponit-main">
		...
		<view v-if="!apponitList.length" class="c-no-data f-center">
			<view>
				<text>暂无预约，</text><text class="p-color" style="font-size: 36upx;" @click="handleToApponit">去预约</text>
			</view>

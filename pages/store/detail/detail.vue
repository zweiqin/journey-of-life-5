<template>
  <view class="brand-detail-container" v-if="brandDetail">
    ...
    <view class="main-area">
      <BrandInfo @follow="handleFollowBrand" @navgation="handleNavigate" :brandDetail="brandDetail"></BrandInfo>
    </view>
    ...
    <view class="main-area brand-pane">
      ...
      <view class="goods-list" style="width: 100%">
        <view class="goods" style="width: 100%" v-show="currentMenu === 0">
          <view v-if="brandDetail.goodsVoList && brandDetail.goodsVoList.length" class="f-s-b" style="flex-wrap: wrap;">
            <BrandGoods @add-car="addShopCar" v-for="goods in brandDetail.goodsVoList" :key="goods.id" :goodsData="goods">
            </BrandGoods>
          </view>
      ...
      <Apponit :apponitList="apponitList" :data="brandDetail" v-show="currentMenu === 3"></Apponit>
    ...
    <view class="shop-car-fixed">
      <BeeIcon @click="go('/user/sever/shop-car')" :src="require('../../../static/brand/detail/shop-car.png')" :size="40">
      </BeeIcon>
    </view>

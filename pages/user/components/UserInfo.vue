<template>
  <view class="user-info-wrapper">
    <view class="default-info">
      <BeeAvatar @click="go(userInfo.userId ? '/user/info/detail' : '/pages/login/login')" :size="80"
        :src="userInfo.userId ? getBeeUrl(userInfo.avatarUrl) : require('../../../static/user-center/default-avatar.png')">
      </BeeAvatar>
      <view @click="go('/pages/login/login')" class="name" v-if="!userInfo.userId">
        登录/注册
      </view>
